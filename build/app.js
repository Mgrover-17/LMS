...
const notification_route_1 = __importDefault(require("./routes/notification_route"));
const analytics_route_1 = __importDefault(require("./routes/analytics_route"));
const layout_route_1 = __importDefault(require("./routes/layout_route"));
//body parser
