...
const course_service_1 = require("../services/course_service");
...
exports.getCourseByUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!courseExists) {
            return next(new ErrorHandler_1.default("You are not eligible to access this resource", 404));
        }
...
exports.addReview = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!courseExists) {
            return next(new ErrorHandler_1.default("You are not elligible to access this course", 404));
        }
        const course = await course_model_1.default.findById(courseId);
        if (!course) {
